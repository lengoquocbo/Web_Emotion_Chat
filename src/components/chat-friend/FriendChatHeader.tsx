    ...
    <header className="rounded-[1.6rem] bg-white/90 px-4 py-3 shadow-[0_14px_36px_rgba(15,23,42,0.06)] backdrop-blur">
      <div className="flex items-start justify-between gap-4">
        <div className="flex min-w-0 items-center gap-3">
          <div className="flex size-10 items-center justify-center rounded-full bg-gradient-to-br from-fuchsia-100 via-rose-50 to-orange-100 text-xs font-semibold text-slate-700 shadow-[0_8px_20px_rgba(15,23,42,0.06)]">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-1 flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.14em] text-slate-400">
              ...
              {friend ? 'Active now' : 'No conversation selected'}
            </div>
          </div>
        </div>
