...
export default function AuthShell({
  ...
  return (
    <div className="h-dvh overflow-hidden bg-[linear-gradient(135deg,#f6ddff_0%,#d6e8ff_100%)] px-4 py-4 sm:px-6 lg:px-8">
      <div className="mx-auto flex h-full max-w-[1360px] flex-col">
          ...
          <div className="grid h-full max-h-[700px] w-full max-w-[1000px] overflow-hidden rounded-[48px] bg-white/55 shadow-[0_30px_90px_rgba(71,85,105,0.18)] backdrop-blur xl:grid-cols-[0.95fr_1.05fr]">
            <section className="min-h-0 overflow-y-auto bg-[linear-gradient(180deg,rgba(244,240,255,0.95)_0%,rgba(235,241,255,0.96)_100%)] px-8 py-8 sm:px-10 sm:py-10 lg:px-12 lg:py-12">
              ...
              <div className="mt-8 max-w-xl">
                <h1 className="text-4xl font-semibold leading-[1.12] tracking-tight text-slate-900 sm:text-5xl">
                  {title}
                </h1>
                <p className="mt-4 max-w-lg text-lg leading-8 text-slate-500">{description}</p>
              </div>
            ...
            >
              ...
              <div className="absolute bottom-10 left-1/2 w-[72%] -translate-x-1/2 rounded-[2.5rem] border border-white/35 bg-white/18 p-8 text-sky-900 shadow-[0_24px_60px_rgba(15,23,42,0.15)] backdrop-blur-xl">
                <div className="flex size-16 items-center justify-center rounded-full bg-emerald-200 text-emerald-950 shadow-[0_12px_30px_rgba(16,185,129,0.18)]">
                  <span className="text-3xl">"</span>
                </div>

                <p className="mt-8 text-[1.6rem] italic leading-[1.5] tracking-tight">
                  The soul always knows what to do to heal itself. The challenge is to silence the
                  mind.
                </p>

                <div className="mt-8 flex items-center gap-4">
                  <div className="flex size-14 items-center justify-center rounded-full bg-slate-700/75 text-sm font-semibold text-white">
                    EV
                  </div>
                  <div>
                    <p className="text-xl font-semibold">Elena Vance</p>
                    <p className="text-base text-sky-900/70">Wellness Lead at Sanctuary</p>
                  </div>
                </div>
              </div>
            </section>
        ...
        <footer className="mt-4 shrink-0 flex flex-wrap items-center justify-center gap-6 px-4 text-sm font-medium uppercase tracking-[0.2em] text-sky-800/75">
